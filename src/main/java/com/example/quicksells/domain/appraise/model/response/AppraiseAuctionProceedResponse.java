...
public class AppraiseAuctionProceedResponse {
    ...
    private final AppraiseStatus appraiseStatus;  // AUCTION_PENDING
    ...
    // 경매 정보
    private final Long auctionId;  // nullable
    private final LocalDateTime expectedAuctionStartTime;  // nullable
